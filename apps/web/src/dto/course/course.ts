...
export class CourseDTO {
  ...
  public static createCourse = {
    body: z.object({
      ...
      prerequisiteCourseIds: z.array(z.string().uuid()).optional(),
      prerequisiteCourseGroupIds: z.array(z.string().uuid()).optional(),
      studentsUserNames: z.array(z.string()).optional(),
      teachersUserNames: z.array(z.string()).optional(),
      code: z.string().min(4).max(10),
    }),
  };
  ...
  public static searchCourseByName = {
    query: z.object({
  ...
  public static searchCourseGroupByName = {
    query: z.object({
      name: z.string().min(1).max(40),
    }),
  };
