...
const sidebarItems = [
  { to: "/courses", icon: "./Courses.svg", label: "Courses" },
  { to: "/schedule", icon: "./Schedule.svg", label: "Schedule" },
  { to: "/exams", icon: "./ExamTime.svg", label: "Exams Time Table" },
  { to: "/grades", icon: "./Grades.svg", label: "Grades" },
  { to: "/evaluation", icon: "./Evaluation.svg", label: "Evaluation" },
  { to: "/finance", icon: "./Financial.svg", label: "Finance" },
  { to: "/live", icon: "./Live.svg", label: "Live Sessions" },
];
    ...
    >
      <div>
        ...
        >
          <NavLink to="/">
            <img
              className={isSidebarOpen ? styles.logo : styles.navLink}
