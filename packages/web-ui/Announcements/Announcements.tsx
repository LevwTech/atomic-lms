...
function Announcements() {
 return (
     <div className= {`h-[100%]  py-[4%]`}>
               <div className={`${styles.header} h-[8vh]  bg-[var(--Primary)] mx-auto w-[90%] mb-[1.5vh] rounded`}>
            <svg
