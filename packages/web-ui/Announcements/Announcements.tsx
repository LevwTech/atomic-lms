  ...
  return (
    <div className={`h-[100%]  py-[4%]`}>
      ...
      {Array.from({ length: 8 }).map(() => (
        <div
          className={` ${styles.AnnouncementsItems} h-[8vh] mx-auto w-[90%]  rounded bg-[var(--WDarker)] flex items-center mb-[1.5vh]`}
        >
          <div className="h-[80%] w-[2%] bg-[var(--Red)] rounded-[2px] ml-[0.8vw]"></div>
